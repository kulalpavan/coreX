...
TEST_DICTIONARY = (
    TestDefinition("hemoglobin", "g/dL", ("hemoglobin (hb/hgb)", "hb", "hgb", "haemoglobin", "hemoglobin")),
    TestDefinition("white_blood_cell_count", "cells/µL", ("white blood cell (wbc)", "white blood cell count", "white blood cells", "white blood cell", "wbc")),
    TestDefinition("red_blood_cell_count", "cells/µL", ("red blood cell (rbc)", "red blood cell count", "red blood cells", "red blood cell", "rbc")),
    TestDefinition("hematocrit", "%", ("hematocrit (hct)", "hematocrit", "hct")),
    TestDefinition("mcv", "fL", ("mean cell volume (mcv)", "mean cell volume", "mean corpuscular volume", "mcv")),
    TestDefinition("mch", "pg", ("mean cell hemoglobin (mch)", "mean cell hemoglobin", "mean corpuscular hemoglobin", "mch")),
    TestDefinition("mchc", "g/dL", ("mean cell hb conc (mchc)", "mean corpuscular hemoglobin concentration", "mchc")),
    TestDefinition("rdw", "%", ("red cell dist width (rdw)", "red cell distribution width", "rdw")),
    TestDefinition("platelet_count", "cells/µL", ("platelet count", "platelets", "plt")),
    TestDefinition("mpv", "fL", ("mean platelet volume", "mpv")),
    TestDefinition("neutrophil", "%", ("neutrophil (neut)", "neutrophil", "neutrophils", "neut")),
    TestDefinition("lymphocyte", "%", ("lymphocyte (lymph)", "lymphocyte", "lymphocytes", "lymph")),
    TestDefinition("monocyte", "%", ("monocyte (mono)", "monocyte", "monocytes", "mono")),
    TestDefinition("eosinophil", "%", ("eosinophil (eos)", "eosinophil", "eosinophils", "eos")),
    TestDefinition("basophil", "%", ("basophil (baso)", "basophil", "basophils", "baso")),
    TestDefinition("neutrophil_abs", "cells/µL", ("neutrophil, absolute", "absolute neutrophils")),
    TestDefinition("lymphocyte_abs", "cells/µL", ("lymphocyte, absolute", "absolute lymphocytes")),
    TestDefinition("monocyte_abs", "cells/µL", ("monocyte, absolute", "absolute monocytes")),
    TestDefinition("eosinophil_abs", "cells/µL", ("eosinophil, absolute", "absolute eosinophils")),
    TestDefinition("basophil_abs", "cells/µL", ("basophil, absolute", "absolute basophils")),
